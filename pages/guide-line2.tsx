...
const GuideLine2: NextPage = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[2000px] overflow-hidden text-left text-3xs text-gray-100 font-inria-sans">
      ...
      <div className="absolute top-[692px] left-[calc(50%_-_371px)] tracking-[0.01em] leading-[20px] font-noto-sans-jp inline-block w-[274px] h-[86px]">
        <p className="m-0">
      ...
      <div className="absolute top-[634px] left-[calc(50%_-_371px)] text-lg leading-[42px] font-noto-sans-jp">
        “Rocket Start” について
      </div>
      <img
        className="absolute top-[231px] left-[222px] w-[207px] h-[126px] overflow-hidden object-cover"
        alt=""
        src="/undefined46.png"
      />
      <div
      ...
      >
        <div className="absolute top-[0px] left-[0px] w-[750px] h-[500px]">
          <div className="absolute top-[0px] left-[0px] bg-orangered-100 w-[500px] h-[500px]" />
      ...
      <img
        className="absolute top-[231px] left-[514px] w-[202px] h-[125px] overflow-hidden object-cover cursor-pointer"
        alt=""
        src="/undefined47.png"
        onClick={onNode1Click}
      />
      <img
        className="absolute top-[1024px] left-[371px] w-[202px] h-[125px] overflow-hidden object-cover"
        alt=""
        src="/undefined48.png"
      />
      <img
      ...
      <div className="absolute top-[60px] left-[67px] w-[209px] h-[18.39px] text-center">
        <img
          className="absolute top-[0px] left-[0px] w-[102px] h-[18.39px] object-cover"
          alt=""
          src="/undefined35.png"
        />

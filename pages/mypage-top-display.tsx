...
const MypageTopDisplay: NextPage = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1487px] overflow-x-auto text-left text-sm text-orangered-100 font-noto-sans-jp">
      ...
      <div className="absolute top-[122px] left-[289px] flex flex-col items-start justify-center gap-[24px] text-gray-200">
        ...
        <div className="relative rounded-md bg-orangered-100 w-[106px] h-[46px] text-center text-white">

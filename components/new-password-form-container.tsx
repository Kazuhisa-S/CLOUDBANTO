...
const NewPasswordFormContainer: NextPage = () => {
  ...
  const onBtnLogInContainerClick = useCallback(() => {
    router.push("/change-password-complete1");
  }, [router]);

  return (
    <div className="absolute h-[60.31%] w-[31.83%] top-[8.03%] right-[34.09%] bottom-[31.65%] left-[34.09%] text-left text-sm text-gray-200 font-noto-sans-jp">
      ...
      />
      <HeaderFixedIcon
        imageDimensions="/undefined33.png"
        propTop="0px"
        propLeft="0px"
        propWidth="81px"
        propHeight="76px"

...
const NavigationsFixed: NextPage<NavigationsFixedType> = ({
  ...
  const div10Style1: CSSProperties = useMemo(() => {
    return {
      color: propColor1,
    };
  }, [propColor1]);
  ...
  return (
    <div className="absolute top-[295px] left-[46px] w-[91px] h-[174px] text-gray-100 absolute top-[295px] left-[46px] w-[91px] h-[174px] text-gray-100">
      <div className="absolute h-[36.21%] w-[2.2%] top-[10.34%] right-[87.91%] bottom-[53.45%] left-[9.89%] bg-gainsboro absolute h-[36.21%] w-[2.2%] top-[10.34%] right-[87.91%] bottom-[53.45%] left-[9.89%] bg-gainsboro" />
      <Navigation1
        companyFormationText="法人設立"

...
const ContainerBox: NextPage = () => {
  ...
  return (
    <div className="absolute top-[405px] left-[291px] w-[545px] h-40 text-black absolute top-[405px] left-[291px] w-[545px] h-40 text-black">
      <BtnMenu
        preparationForIncorporati="法人設立"
      ...
      />
      <img
        className="absolute top-[68px] left-[153px] w-[64.42px] h-[70.35px] object-cover absolute top-[68px] left-[153px] w-[64.42px] h-[70.35px] object-cover"
        alt=""
        src="/undefined27.png"
      />
      <BtnMenu
      ...
      />
      <img
        className="absolute top-[67px] left-[455px] w-[71.23px] h-[71px] object-cover absolute top-[67px] left-[455px] w-[71.23px] h-[71px] object-cover"
        alt=""
        src="/undefined28.png"
      />
    </div>

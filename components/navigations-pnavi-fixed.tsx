...
type NavigationsPnaviFixedType = {
  companyFormationBusinessP?: string;
...
const NavigationsPnaviFixed: NextPage<NavigationsPnaviFixedType> = ({
  ...
  return (
    <div
      className="[background:linear-gradient(#fff,_#fff),_linear-gradient(#fff,_#fff),_#fff] box-border w-[965px] h-[62px] text-left text-xs text-gray-200 font-noto-sans border-[1px] border-solid border-whitesmoke-200"

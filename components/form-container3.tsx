...
const FormContainer3: NextPage = () => {
  return (
    <div className="absolute top-[122px] left-[291px] flex flex-col items-start justify-start gap-[24px] text-left text-sm text-gray-200 font-noto-sans-jp">
      ...
      <div className="relative w-[107px] h-[46px] text-center text-white">
        <div className="absolute top-[0px] left-[0px] rounded-md bg-orangered-100 w-[107px] h-[46px]" />

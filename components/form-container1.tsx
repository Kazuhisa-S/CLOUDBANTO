...
const FormContainer1: NextPage = () => {
  ...
  return (
    <div className="absolute top-[68px] left-[calc(50%_-_208px)] flex flex-col items-start justify-start gap-[24px] text-left text-sm text-gray-200 font-noto-sans-jp">
      <HeaderFixedIcon
